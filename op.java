...
package unifamtro.edu;
import java.util.Scanner;
public class op {
static Scanner in = new Scanner(System.in);
    public static void main(String[] args) {
  
    double num1, num2, r; //num1 num2 para declaração de valores; r = resultado
    char op; // Para Selecionar Operação

    System.out.print("Olá Usuário!, Informe a Operação que Deseja Execultar Logo Abaixo:\n ");
